  ...
  const contactInfo = [
    {
      ...
      title: "Address",
      content:
        "No. 7, Adepate Abebi Crescent, Off Idi-Ishin Police Station, Jericho Road, Ibadan, Oyo State, Nigeria.",
    },
    {
      icon: Phone,
      title: "Phone",
      content: "+234 803 242 9497",
      href: "tel:+2348032429497",
    },
    {
      icon: Mail,
      title: "Email",
      content: "stallionslegal@gmail.com",
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="h-64 rounded-lg bg-muted flex items-center justify-center border border-border overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3956.50992393567!2d3.8534118747374873!3d7.408674812245!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x10398d7c35883ced%3A0xbce37c5bf7c9c0a5!2sON-LINE%20DYNAMICS%20LTD!5e0!3m2!1sen!2sng!4v1770985315395!5m2!1sen!2sng"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
