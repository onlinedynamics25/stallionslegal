  ...
  const steps = [
    {
      ...
      description:
        "We begin every engagement by understanding your situation, objectives, and constraints. No assumptions. No generic advice. Every matter is assessed on its own facts.",
    ...
    },
    {
      ...
      description:
        "We analyse your matter to identify legal risks, compliance gaps, and exposure points before they become problems.",
    ...
    },
    {
      ...
      description:
        "Our recommendations are practical, lawful, and structured for execution — not abstract legal theory.",
    ...
    },
    {
      ...
      description:
        "We assist with documentation, implementation, follow-up, and compliance support to ensure advice translates into results.",
      ...
      <div className="container mx-auto px-4">
            ...
            {steps.map((step, index) => (
              <div key={step.number} className="relative">
                ...
                <div className="flex flex-col items-center mb-6">
                  <span className="text-gold font-serif font-bold text-lg mb-2">
                    {step.number}
                  </span>
          ...
          {steps.map((step, index) => (
            <div key={step.number} className="flex gap-6">
              ...
              <div className="flex-1 pb-8">
                ...
                <p className="text-sm text-gold italic mb-3">{step.subtitle}</p>
                <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
                  {step.description}
                </p>
                <div className="bg-cream rounded-lg p-3">
        ...
        <div className="text-center border-t border-border pt-12">
          ...
          <p className="text-muted-foreground mb-8">
            Law delivered with structure, clarity, and professional
            responsibility.
          </p>
          <Button
