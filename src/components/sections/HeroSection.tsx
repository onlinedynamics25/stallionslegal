        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-primary-foreground/80 max-w-lg leading-relaxed">
              Practical legal counsel built on trust, structure, and disciplined execution. 
              We focus on risk prevention, legal clarity, and long-term client relationships — 
              not reactive advice or unnecessary complexity.
            </p>
          ...
          <div className="hidden lg:flex justify-center items-center relative">
            ...
            <div className="absolute bottom-10 left-0 bg-charcoal-light/90 backdrop-blur-sm rounded-lg p-4 border border-gold/20">
              ...
              <p className="text-xs text-primary-foreground/60">Legal Solutions</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 lg:gap-12">
            {trustSignals.map((signal) => (
              <div key={signal} className="flex items-center gap-2">
                ...
                <span className="text-sm text-primary-foreground/70">{signal}</span>
              </div>
            ))}
          </div>
        </div>
